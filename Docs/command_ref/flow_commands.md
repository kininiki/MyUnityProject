...
# Load Scene With History # {#LoadSceneWithHistory}
Loads a new Unity scene and adds it to the scene history.

Defined in Fungus.LoadSceneWithHistory

Property | Type | Description
 --- | --- | ---
Scene Name | Fungus.StringData | Name of the scene to load. The scene must also be added to the build settings.
